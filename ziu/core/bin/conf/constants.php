...
define('ZIU_MAIN_PATH',        dirname(dirname(dirname(dirname(__FILE__)))) . DS);
// Core path in ziu.
...
define('ZIU_CORE_CONF_PATH',   ZIU_CORE_BIN_PATH . 'conf' . DS);
// Functional file and directory prefix.
define('ZIU_FUNC_PREFIX',      '.');
define('ZIU_USER_FUNC_PREFIX', '_'); // same prefix as ZIU_FUNC_PREFIX in core/conf/constants.php
// Apps path in ziu.
define('ZIU_APPS_PATH',        ZIU_CORE_BIN_PATH . 'apps' . DS);
define('ZIU_USER_APPS_PATH',   ZIU_MAIN_PATH . 'apps' . DS);
...
// for user
define('ZIU_USER_CONF_DIR',         ZIU_USER_FUNC_PREFIX . 'conf');
define('ZIU_USER_INIT_DIR',         ZIU_USER_FUNC_PREFIX . 'init');
define('ZIU_USER_HELP_DIR',         ZIU_USER_FUNC_PREFIX . 'help');
define('ZIU_USER_BIN_DIR',          ZIU_USER_FUNC_PREFIX . 'bin');
define('ZIU_USER_LIB_DIR',          ZIU_USER_FUNC_PREFIX . 'lib');
define('ZIU_USER_LAYOUT_DIR',       ZIU_USER_FUNC_PREFIX . 'layout');
define('ZIU_USER_MODEL_DIR',        ZIU_USER_FUNC_PREFIX . 'model');
define('ZIU_USER_UNIT_DIR',         ZIU_USER_FUNC_PREFIX . 'unit');
define('ZIU_USER_VENDOR_DIR',       ZIU_USER_FUNC_PREFIX . 'vendor');
/**
 * Error Level
 */
